...
public class MyRunnerConfig implements CommandLineRunner {
    ...
    private void gitInfoConfig() {
        ...
        Assert.notNull(gitInfoConfig.getUsername(), "git username为空，请检测application.properties");
        Assert.notNull(gitInfoConfig.getPassword(), "git password为空，请检测application.properties");
    }
