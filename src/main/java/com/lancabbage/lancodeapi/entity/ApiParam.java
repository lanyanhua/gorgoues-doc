...
public class ApiParam {
    ...
    /**
     * 传参方式，1：form-data 2：post json格式 3：path {id}
     */
    ...
    /**
     * 获取传参方式，1：form-data 2：post json格式 3：path {id}
     *
     * @return param_mode - 传参方式，1：form-data 2：post json格式 3：path {id}
     */
    ...
    /**
     * 设置传参方式，1：form-data 2：post json格式 3：path {id}
     *
     * @param paramMode 传参方式，1：form-data 2：post json格式 3：path {id}
     */
